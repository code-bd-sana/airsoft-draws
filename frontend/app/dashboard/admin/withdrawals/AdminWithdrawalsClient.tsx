    ...
    <div className="flex flex-col gap-6 p-8 max-w-[1660px] mx-auto w-full animate-fadeIn">
      <div>
        ...
        <p className="font-sans text-sm text-[#72943A]">
          Review and process payout requests from competition hosts. Withdrawals deduct platform commission based on the host plan (15% for Free, 10% for Premium/Pro).
        </p>
      </div>
