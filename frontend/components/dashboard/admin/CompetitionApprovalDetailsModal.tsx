...
export default function CompetitionApprovalDetailsModal({
  ...
  return (
    <>
      ...
      {/* Modal Dialog */}
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[95%] max-w-[840px] max-h-[92vh] bg-[#161810] border border-[#2D3C13] rounded-[20px] shadow-2xl z-50 animate-fadeIn flex flex-col overflow-hidden">
        
        {/* Modal Header */}
        <div className="px-6 py-5 border-b border-[#2D3C13] flex items-start justify-between gap-4 bg-[#111210]">
          <div className="flex flex-col gap-1.5 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-2.5 py-0.5 rounded-full bg-[#78350F]/70 text-[#F59E0B] border border-[#D97706]/40 font-sans font-medium text-[11px] uppercase tracking-wider">
                Pending Approval
              </span>
            ...
            <h2 className="font-heading font-bold text-[20px] sm:text-[22px] text-[#E8EDD4] truncate leading-tight mt-1">
              {competition.title}
            </h2>
          </div>
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-[#1A230A] hover:bg-[#2D3C13] text-[#8CB34A] hover:text-[#E8EDD4] border border-[#2D3C13] flex items-center justify-center transition-colors shrink-0 cursor-pointer"
        ...
        {/* Tab Navigation */}
        <div className="flex items-center border-b border-[#2D3C13] bg-[#111210]/60 px-6">
          <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">
                  ...
                  <div className="p-4 rounded-[10px] bg-[#161810] border border-[#2D3C13] flex flex-col gap-1">
                    <div className="flex items-center gap-2 text-[#8CB34A] text-xs font-semibold uppercase tracking-wide">
                      <span className="w-2.5 h-2.5 rounded-full bg-[#8CB34A] inline-block"></span>
        ...
        <div className="p-4 sm:p-5 bg-[#111210] border-t border-[#2D3C13] flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          <button
            onClick={onClose}
            className="w-full sm:w-auto h-[42px] px-6 rounded-[8px] bg-[#1A230A] border border-[#2D3C13] hover:bg-[#2D3C13] text-[#E8EDD4] font-heading font-medium text-sm transition-colors cursor-pointer"
          >
            Close
          </button>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none h-[42px] px-6 rounded-[8px] bg-transparent border border-[#7F1D1D] hover:bg-[#7F1D1D]/20 text-[#f76b6b] cursor-pointer font-heading font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Reject Competition
            </button>
            <button
              ...
              disabled={isApproving}
              className="flex-1 sm:flex-none h-[42px] px-6 rounded-[8px] bg-[#8CB34A] hover:bg-[#A0D056] text-[#0D0D0B] font-heading font-semibold text-sm transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(140,179,74,0.2)]"
            >
              {isApproving ? (
                <>
                  <div className="w-4 h-4 border-2 border-[#0D0D0B] border-t-transparent rounded-full animate-spin" />
                  <span>Approving...</span>
                </>
              ) : (
                <>
