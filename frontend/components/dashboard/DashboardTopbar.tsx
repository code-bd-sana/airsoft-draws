      ...
      <div className="flex items-center gap-[16px]">
        ...
        <div className="relative">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] px-1 bg-[#f76b6b] text-white text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-[#0D0D0B] shadow-sm">
